// p5 sketch — pairs with Arduino example 03_P5Phone_Input.
//
// Receives a float "temp" via notify. The Arduino SENDS temp; the phone
// RECEIVES it. Install p5-phone, paste this into sketch.js, run on
// Chrome/Edge over HTTPS (iPhone/iPad: Bluefy browser).
//
// (Copied verbatim from p5-phone examples/Phone Sensor Examples/ble/01_ble_input.)
...
function bleReady(deviceName) { debug('bleReady: ' + deviceName); }
function bleClosed() { displayTemp = null; debug('bleClosed'); }
