...
window.P5PHONE_EXAMPLES = [
  ...
  },
  {
    ...
    level: 'Starter',
    p5: '1.x and 2.0',
    description: 'Receive-only: connect to a BLE sensor and read float temperature notifications.',
  ...
  },
  {
    ...
    level: 'Starter',
    p5: '1.x and 2.0',
    description: 'Send-only: connect to a BLE device and write uint8 brightness values from touch.',
    path: 'Phone%20Sensor%20Examples/ble/02_ble_send/',
  ...
  },
  {
    ...
    level: 'Intermediate',
    p5: '1.x and 2.0',
    description: 'Bidirectional: receive temp notifications and send brightness on one BLE connection.',
