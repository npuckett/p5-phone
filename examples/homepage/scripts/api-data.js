window.P5PHONE_PERMISSION_MATRIX = [
  ...
  { capability: 'Microphone', status: 'window.micEnabled', tap: 'enableMicTap(message)', button: 'enableMicButton(text)', canvas: 'enableMicCanvas(message)', banner: 'enableMicBanner(message, position)', minimal: 'enableMicMinimal(message|opts)', custom: 'enableMicOn(selector)', notes: 'Requires p5.sound when using p5.AudioIn.' },
